Dimensionality Reduction: A primer for biologists
================
...
Biological data is inherently non-linear because of the complex
...
that the algorithm will use when constructing the low-dimensional
